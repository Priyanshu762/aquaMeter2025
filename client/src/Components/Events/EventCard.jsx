  ...
  return (
    <div className="relative flex flex-col bg-white dark:bg-gray-800 shadow-sm border border-slate-200 dark:border-gray-700 rounded-lg w-full md:w-80 z-10">
      ...
      <div className="p-4">
        ...
        <button onClick={() => navigate(`/event/${event._id}`)} className="rounded-md w-full mt-6 bg-cyan-600 dark:bg-cyan-700 py-2 px-4 text-white text-sm transition-all shadow-md hover:bg-cyan-700 dark:hover:bg-cyan-800 cursor-pointer" type="button">
          Register Now
        </button>
      </div>
    </div>
