...
const ForecastTile = () => {
  return (
    <div className="duration-300 font-mono text-white group cursor-pointer relative overflow-hidden bg-[#22272B] w-24 h-32 dark:bg-[#22272B] rounded-3xl p-3 hover:w-46 hover:bg-[#0C66E4] hover:dark:bg-[#0C66E4]">
      <h3 className="text-xl text-center mx-auto">Today</h3>
      <div className="gap-4 relative">
        <svg viewBox="0 0 64 64" xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" className="w-12 scale-[100%]">
          <defs>
          ...
          <path d="M38.39 43.03l-.78 4.94" strokeWidth={2} strokeMiterlimit={10} strokeLinecap="round" stroke="url(#e)" fill="none">
            <animateTransform values="1 -5; -2 10" type="translate" repeatCount="indefinite" dur="0.7s" begin="-0.2s" attributeName="translate-x-8" />
          </path>
        </svg>
        <h4 className="font-sans duration-300 absolute left-1/2 -translate-x-1/2 text-xl text-center group-hover:translate-x-5 group-hover:-translate-y-10 group-hover:scale-100">
          26°
        </h4>
      </div>
