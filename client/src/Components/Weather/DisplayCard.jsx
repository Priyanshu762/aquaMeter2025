...
const DisplayCard = ({ temperature, high, low, location, weather }) => {
  return (
    <StyledWrapper>
      <div className="card">
        <svg fill="none" viewBox="0 0 342 175" height={175} width={342} xmlns="http://www.w3.org/2000/svg" className="background">
          <path
            ...
            className="dark:fill-[url(#darkGradient)] transition-all duration-300 "
          ...
          <defs>
            ...
            <linearGradient id="darkGradient" x1="0%" y1="0%" x2="100%" y2="0%">
              ...
              <stop offset="100%" stopColor="#362A84" />
            </linearGradient>
            
          </defs>
        </svg>
        <Rain />
        <p className="main-text text-black dark:text-white ">{temperature}°</p>
        <div className="info text-black dark:text-white ">
          <div className="info-left">
            <p className="text-gray-700 dark:text-gray-300 ">H:{high}° L: {low}°</p>
            <p>{location}</p>
          </div>
          <p className="info-right mr-4">{weather}</p>
        </div>
      </div>
    </StyledWrapper>
  );
